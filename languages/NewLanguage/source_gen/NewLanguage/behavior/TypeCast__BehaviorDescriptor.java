...
public final class TypeCast__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x80fd2975f5c34fe6L, 0xa787f3eac6fef3beL, 0x39c216b1a473fd97L, "NewLanguage.structure.TypeCast");
  ...
  /*package*/ static Object computeImpl_idb_il9omHZr(@NotNull SNode __thisNode__, Frame frame, EvaluatorEnvironment env) {
    return (Object) DataType__BehaviorDescriptor.castObject_id3B25F6$xs78.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.type$8$ZP), Expression__BehaviorDescriptor.compute_idb_il9omFIS.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.exp$8_tR), frame, env));
  }

  /*package*/ TypeCast__BehaviorDescriptor() {
  }
