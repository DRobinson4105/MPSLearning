...
public final class LExpression__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<ExpressionResult> computeL_idb_il9oY767 = new SMethodBuilder<ExpressionResult>(new SJavaCompoundTypeImpl(ExpressionResult.class)).name("computeL").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(208653575771419015L).languageId(0xa787f3eac6fef3beL, 0x80fd2975f5c34fe6L).build2(SMethodBuilder.createJavaParameter(Frame.class, ""), SMethodBuilder.createJavaParameter(EvaluatorEnvironment.class, ""));
