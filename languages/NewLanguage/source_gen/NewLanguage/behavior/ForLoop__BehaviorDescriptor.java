...
public final class ForLoop__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<List<SNode>> getVariableDeclarations_id25KMk5z1toL = new SMethodBuilder<List<SNode>>(new SJavaCompoundTypeImpl((Class<List<SNode>>) ((Class) Object.class))).name("getVariableDeclarations").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("25KMk5z1toL").build(SMethodBuilder.createJavaParameter((Class<SNode>) ((Class) Object.class), ""));
  public static final SMethod<List<SNode>> getVariableDeclarations_id25KMk5z1tpL = new SMethodBuilder<List<SNode>>(new SJavaCompoundTypeImpl((Class<List<SNode>>) ((Class) Object.class))).name("getVariableDeclarations").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("25KMk5z1tpL").build(SMethodBuilder.createJavaParameter(Integer.TYPE, ""));
