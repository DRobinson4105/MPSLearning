...
public final class IncrementBefore__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x80fd2975f5c34fe6L, 0xa787f3eac6fef3beL, 0x2e54952595afaf4L, "NewLanguage.structure.IncrementBefore");
  ...
  /*package*/ static ExpressionResult computeLImpl_idb_il9oY7IT(@NotNull SNode __thisNode__, final Frame frame, EvaluatorEnvironment env) {
    ...
    final Object val = as_lehurr_a0a0b0k(exp.get(), Integer.class) + 1;
    exp.set(val);
  ...
  /*package*/ IncrementBefore__BehaviorDescriptor() {
  }
  ...
  private static <T> T as_lehurr_a0a0b0k(Object o, Class<T> type) {
