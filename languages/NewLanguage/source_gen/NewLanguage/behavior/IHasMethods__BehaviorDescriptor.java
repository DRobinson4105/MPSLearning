...
public final class IHasMethods__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<List<SNode>> getMethodDeclarations_id6ACCDiYMl72 = new SMethodBuilder<List<SNode>>(new SJavaCompoundTypeImpl((Class<List<SNode>>) ((Class) Object.class))).name("getMethodDeclarations").modifiers(12, AccessPrivileges.PUBLIC).concept(CONCEPT).id("6ACCDiYMl72").build();
