...
public final class ExpressionStatement__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x80fd2975f5c34fe6L, 0xa787f3eac6fef3beL, 0x2f07de64655f40f2L, "NewLanguage.structure.ExpressionStatement");
  ...
  /*package*/ static void runB_id1lixMam2fw2(@NotNull SNode __thisNode__, Frame frame, EvaluatorEnvironment env) {
    Expression__BehaviorDescriptor.compute_idb_il9omFIS.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.expression$LFbP), frame, env);
  }
