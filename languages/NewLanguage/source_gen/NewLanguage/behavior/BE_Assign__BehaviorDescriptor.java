...
public final class BE_Assign__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x80fd2975f5c34fe6L, 0xa787f3eac6fef3beL, 0x2e5495258f852fbL, "NewLanguage.structure.BE_Assign");
  ...
  /*package*/ static Object computeImpl_idb_il9omHZr(@NotNull SNode __thisNode__, Frame frame, EvaluatorEnvironment env) {
    Object val = Expression__BehaviorDescriptor.compute_idb_il9omFIS.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.right$jytp), frame, env);

    if (SNodeOperations.isInstanceOf(SLinkOperations.getTarget(__thisNode__, LINKS.left$sDis), CONCEPTS.LExpression$8F)) {
      LExpression__BehaviorDescriptor.computeL_idb_il9oY767.invoke(SNodeOperations.as(SLinkOperations.getTarget(__thisNode__, LINKS.left$sDis), CONCEPTS.LExpression$8F), frame, env).set(val);
      return val;
    }
  ...
  /*package*/ BE_Assign__BehaviorDescriptor() {
  }
