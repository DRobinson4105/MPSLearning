...
public final class CatchStatement__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x80fd2975f5c34fe6L, 0xa787f3eac6fef3beL, 0x2bfa9913b41b25e3L, "NewLanguage.structure.CatchStatement");
  ...
  /*package*/ static Scope getScope_id52_Geb4QDV$(@NotNull SNode __thisNode__, SAbstractConcept kind, SNode child) {
    ...
    switch (conceptIndex.index(cncpt)) {
      case 0:
        return CompositeWithParentScope.from(SLinkOperations.getTarget(__thisNode__, LINKS.parameter$m$CX), __thisNode__, kind);
      default:
        return null;
    }
  }
  ...
  /*package*/ CatchStatement__BehaviorDescriptor() {
  }
