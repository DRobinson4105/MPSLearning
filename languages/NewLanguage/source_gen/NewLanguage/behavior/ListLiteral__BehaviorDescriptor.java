...
public final class ListLiteral__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x80fd2975f5c34fe6L, 0xa787f3eac6fef3beL, 0x2e54952594c811cL, "NewLanguage.structure.ListLiteral");
  ...
  /*package*/ static Object computeImpl_idb_il9omHZr(@NotNull SNode __thisNode__, final Frame frame, final EvaluatorEnvironment env) {
    return ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, LINKS.elements$ZvoG)).select(new ISelector<SNode, Object>() {
  ...
  /*package*/ ListLiteral__BehaviorDescriptor() {
  }
