...
public final class IDotOperation__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Object> compute_id25KMk5ynPAQ = new SMethodBuilder<Object>(new SJavaCompoundTypeImpl(Object.class)).name("compute").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(2409647083303688630L).languageId(0xa787f3eac6fef3beL, 0x80fd2975f5c34fe6L).build2(SMethodBuilder.createJavaParameter((Class<SNode>) ((Class) Object.class), ""), SMethodBuilder.createJavaParameter(Frame.class, ""), SMethodBuilder.createJavaParameter(EvaluatorEnvironment.class, ""));
  ...
  public static final SMethod<ExpressionResult> computeL_id25KMk5yq1jB = new SMethodBuilder<ExpressionResult>(new SJavaCompoundTypeImpl(ExpressionResult.class)).name("computeL").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(2409647083304260839L).languageId(0xa787f3eac6fef3beL, 0x80fd2975f5c34fe6L).build2(SMethodBuilder.createJavaParameter((Class<SNode>) ((Class) Object.class), ""), SMethodBuilder.createJavaParameter(Frame.class, ""), SMethodBuilder.createJavaParameter(EvaluatorEnvironment.class, ""));
  ...
  public static final SMethod<SNode> dotFromContext_id2JUAheNhVmb = new SMethodBuilder<SNode>(new SJavaCompoundTypeImpl((Class<SNode>) ((Class) Object.class))).name("dotFromContext").modifiers(1, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(3169013597699814795L).languageId(0xa787f3eac6fef3beL, 0x80fd2975f5c34fe6L).build2(SMethodBuilder.createJavaParameter((Class<SNode>) ((Class) Object.class), ""));
