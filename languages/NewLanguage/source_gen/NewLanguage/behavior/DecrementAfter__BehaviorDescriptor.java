...
public final class DecrementAfter__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x80fd2975f5c34fe6L, 0xa787f3eac6fef3beL, 0x2e54952595afaf5L, "NewLanguage.structure.DecrementAfter");
  ...
  /*package*/ static ExpressionResult computeLImpl_idb_il9oY7IT(@NotNull SNode __thisNode__, final Frame frame, EvaluatorEnvironment env) {
    ...
    exp.set(as_shrk05_a0a0a2a01(exp.get(), Integer.class) - 1);
  ...
  /*package*/ DecrementAfter__BehaviorDescriptor() {
  }
  ...
  private static <T> T as_shrk05_a0a0a2a01(Object o, Class<T> type) {
