...
public final class Document__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x80fd2975f5c34fe6L, 0xa787f3eac6fef3beL, 0x580a917d12c3a82aL, "NewLanguage.structure.Document");
  ...
  /*package*/ static Scope getScope_id52_Geb4QDV$(@NotNull SNode __thisNode__, SAbstractConcept kind, SNode child) {
    ...
    switch (conceptIndex.index(cncpt)) {
      case 0:
        return CompositeWithParentScope.from(ListScope.forNamedElements(SLinkOperations.getChildren(__thisNode__, LINKS.functions$GIYJ)), __thisNode__, kind);
      case 1:
        return CompositeWithParentScope.from(ListScope.forNamedElements(SLinkOperations.getChildren(__thisNode__, LINKS.structs$ezJQ)), __thisNode__, kind);
      case 2:
        return CompositeWithParentScope.from(ListScope.forNamedElements(SLinkOperations.getChildren(__thisNode__, LINKS.traits$X4k)), __thisNode__, kind);
      default:
    }
    return null;
  }
  ...
  private static final ConceptSwitchIndex conceptIndex = new ConceptSwitchIndexBuilder().put(MetaIdFactory.conceptId(0x80fd2975f5c34fe6L, 0xa787f3eac6fef3beL, 0x2e54952596b4e3eL), MetaIdFactory.conceptId(0x80fd2975f5c34fe6L, 0xa787f3eac6fef3beL, 0x2170c9416229bf84L), MetaIdFactory.conceptId(0x80fd2975f5c34fe6L, 0xa787f3eac6fef3beL, 0x2bfa9913b4017060L)).seal();
  private static final ConceptSwitchIndex conceptIndex1 = new ConceptSwitchIndexBuilder().put(MetaIdFactory.conceptId(0x80fd2975f5c34fe6L, 0xa787f3eac6fef3beL, 0x2e54952596b4e3eL)).seal();
