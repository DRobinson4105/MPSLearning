...
public final class TraitDeclaration__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<List<SNode>> getMethodDeclarations_id6ACCDiYPVHu = new SMethodBuilder<List<SNode>>(new SJavaCompoundTypeImpl((Class<List<SNode>>) ((Class) Object.class))).name("getMethodDeclarations").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("6ACCDiYPVHu").build();
  public static final SMethod<Set<SNode>> getAllSuperTraits_id6ACCDiX9mcX = new SMethodBuilder<Set<SNode>>(new SJavaCompoundTypeImpl((Class<Set<SNode>>) ((Class) Object.class))).name("getAllSuperTraits").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("6ACCDiX9mcX").build();
  public static final SMethod<Set<SNode>> getAllSuperTraits_id6ACCDiXbsSp = new SMethodBuilder<Set<SNode>>(new SJavaCompoundTypeImpl((Class<Set<SNode>>) ((Class) Object.class))).name("getAllSuperTraits").modifiers(1, AccessPrivileges.PUBLIC).concept(CONCEPT).id("6ACCDiXbsSp").build(SMethodBuilder.createJavaParameter((Class<Iterable<SNode>>) ((Class) Object.class), ""));
  public static final SMethod<List<SNode>> getAllSuperTypes_id6ACCDiZifQ2 = new SMethodBuilder<List<SNode>>(new SJavaCompoundTypeImpl((Class<List<SNode>>) ((Class) Object.class))).name("getAllSuperTypes").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("6ACCDiZifQ2").build();
