...
public final class StructType__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  /*package*/ static List<SNode> getMethodDeclarations_id6ACCDiYMl72(@NotNull SNode __thisNode__) {
    return (List<SNode>) StructDeclaration__BehaviorDescriptor.getMethodDeclarations_id2JUAheO2Fau.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.structDec$QCZG));
  }
