...
public class TraitReference_Constraints extends BaseConstraintsDescriptor {
  public TraitReference_Constraints() {
    super(CONCEPTS.TraitReference$YD);
  }

  @Override
  protected Map<SReferenceLink, ReferenceConstraintsDescriptor> getSpecifiedReferences() {
    BaseReferenceConstraintsDescriptor d0 = new BaseReferenceConstraintsDescriptor(LINKS.trait$AxyP, this, true, false) {
      @Nullable
      @Override
      public ReferenceScopeProvider getScopeProvider() {
        return ReferenceScopeProvider.fromHierarchy(CONCEPTS.TraitDeclaration$N5, new SNodePointer("r:990720bc-e202-44f5-9c0f-d93b699e40ca(NewLanguage.constraints)", "7613513929814153348"));
      }
    };
