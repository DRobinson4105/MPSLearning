...
public class GrammarCellsSubstituteMenu_TraitType extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_TraitType() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_jwcgh2_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "TraitType", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_jwcgh2_a extends GrammarCellsSubstituteMenuPart {
    @Override
