...
public class GrammarCellsSubstituteMenu_CatchParameter extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_CatchParameter() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_qf56lh_a());
    return result;
  }
  ...
  private class GrammarCellsSubstituteMenuPart_qf56lh_a extends GrammarCellsSubstituteMenuPart {
    @Override
