...
public class GrammarCellsSubstituteMenu_IHasCondition extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_IHasCondition() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_2xrq13_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "IHasCondition", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_2xrq13_a extends GrammarCellsSubstituteMenuPart {
    @Override
