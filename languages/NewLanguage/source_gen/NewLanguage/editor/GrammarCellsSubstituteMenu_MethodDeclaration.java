...
public class GrammarCellsSubstituteMenu_MethodDeclaration extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_MethodDeclaration() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_yrgjz2_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "MethodDeclaration", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_yrgjz2_a extends GrammarCellsSubstituteMenuPart {
    @Override
