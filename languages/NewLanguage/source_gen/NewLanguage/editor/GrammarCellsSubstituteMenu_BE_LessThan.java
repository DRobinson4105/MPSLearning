...
public class GrammarCellsSubstituteMenu_BE_LessThan extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_BE_LessThan() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_6yke4d_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "BE_LessThan", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_6yke4d_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.BE_LessThan$OT;
    }
  }
