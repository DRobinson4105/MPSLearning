...
public class GrammarCellsSubstituteMenu_BE_EqualTo extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_BE_EqualTo() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_ur6hjr_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "BE_EqualTo", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_ur6hjr_a extends GrammarCellsSubstituteMenuPart {
    @Override
