...
public class GrammarCellsSubstituteMenu_BE_Minus extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_BE_Minus() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_61ha94_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "BE_Minus", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_61ha94_a extends GrammarCellsSubstituteMenuPart {
    @Override
