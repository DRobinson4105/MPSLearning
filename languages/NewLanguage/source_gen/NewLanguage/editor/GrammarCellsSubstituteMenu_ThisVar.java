...
public class GrammarCellsSubstituteMenu_ThisVar extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_ThisVar() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_j848sm_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "ThisVar", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_j848sm_a extends GrammarCellsSubstituteMenuPart {
    @Override
