...
public class GrammarCellsSubstituteMenu_FieldAccessor extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_FieldAccessor() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_3a3oiq_a());
    return result;
  }
  ...
  private class GrammarCellsSubstituteMenuPart_3a3oiq_a extends GrammarCellsSubstituteMenuPart {
    @Override
