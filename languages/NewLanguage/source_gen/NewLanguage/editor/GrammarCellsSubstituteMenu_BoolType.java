...
public class GrammarCellsSubstituteMenu_BoolType extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_BoolType() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_y6281c_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "BoolType", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_y6281c_a extends GrammarCellsSubstituteMenuPart {
    @Override
