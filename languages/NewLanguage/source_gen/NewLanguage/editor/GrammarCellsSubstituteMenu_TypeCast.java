...
public class GrammarCellsSubstituteMenu_TypeCast extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_TypeCast() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_bzjhp6_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "TypeCast", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_bzjhp6_a extends GrammarCellsSubstituteMenuPart {
    @Override
