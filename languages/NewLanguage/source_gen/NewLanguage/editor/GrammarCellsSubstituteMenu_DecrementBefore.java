...
public class GrammarCellsSubstituteMenu_DecrementBefore extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_DecrementBefore() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_sy49t7_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "DecrementBefore", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_sy49t7_a extends GrammarCellsSubstituteMenuPart {
    @Override
