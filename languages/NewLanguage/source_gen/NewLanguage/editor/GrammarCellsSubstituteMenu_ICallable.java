...
public class GrammarCellsSubstituteMenu_ICallable extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_ICallable() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_4u1zrm_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "ICallable", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_4u1zrm_a extends GrammarCellsSubstituteMenuPart {
    @Override
