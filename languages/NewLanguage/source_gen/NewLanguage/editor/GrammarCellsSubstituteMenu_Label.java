...
public class GrammarCellsSubstituteMenu_Label extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_Label() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_e80a7g_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "Label", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_e80a7g_a extends GrammarCellsSubstituteMenuPart {
    @Override
