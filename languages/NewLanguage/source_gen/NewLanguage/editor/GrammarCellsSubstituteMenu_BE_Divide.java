...
public class GrammarCellsSubstituteMenu_BE_Divide extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_BE_Divide() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_7kgtho_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "BE_Divide", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_7kgtho_a extends GrammarCellsSubstituteMenuPart {
    @Override
