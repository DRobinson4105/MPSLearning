...
/*package*/ class DecrementBefore_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public DecrementBefore_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_lkxbv1_a");
      ...
      public EditorCell invoke() {
        cell.setAction(CellActionType.DELETE, new CellActionWithReadAccess() {
          public void execute(EditorContext editorContext) {
            ...
            SNode unwrapped = SNodeOperations.replaceWithAnother(node, SLinkOperations.getTarget(node, LINKS.exp$gRXM));
          ...
          public boolean canExecute_inReadAction(EditorContext editorContext) {
            ...
            SNode replacement = SLinkOperations.getTarget(node, LINKS.exp$gRXM);
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_lkxbv1_a0a");
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new expSingleRoleHandler_lkxbv1_b0(myNode, LINKS.exp$gRXM, getEditorContext());
    return provider.createCell();
  }
  private static class expSingleRoleHandler_lkxbv1_b0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public expSingleRoleHandler_lkxbv1_b0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
    ...
    protected EditorCell createChildCell(SNode child) {
      ...
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), LINKS.exp$gRXM, child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), LINKS.exp$gRXM, child));
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      ...
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(LINKS.exp$gRXM);
      }
    }
    @Override
    protected EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), LINKS.exp$gRXM));
      try {
