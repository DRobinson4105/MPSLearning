...
public class VarReference_SubstituteMenu extends SubstituteMenuBase {
  ...
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new ConstraintsFilteringSubstituteMenuPartDecorator(new SMP_ReferenceScope_a5loq2_a(), CONCEPTS.VarReference$Jg));
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("default substitute menu for VarReference. Generated from implicit smart reference attribute.", new SNodePointer("r:1a359b01-6c7c-4105-ba93-a2467014847a(NewLanguage.structure)", "3388921767394977683")));
    try {
  ...
  public class SMP_ReferenceScope_a5loq2_a extends ReferenceScopeSubstituteMenuPart {
    ...
    public SMP_ReferenceScope_a5loq2_a() {
      ...
      super((SAbstractConcept) CONCEPTS.VarReference$Jg, LINKS.var$iTQl);
    }
    @NotNull
    @Override
  ...
  public class SMP_Subconcepts_a5loq2_b extends ConceptMenusPart<SubstituteMenuItem, SubstituteMenuContext> {
    protected Collection getConcepts(final SubstituteMenuContext _context) {
      return ConceptDescendantsCache.getInstance().getDirectDescendants(CONCEPTS.VarReference$Jg);
    }
    @NotNull
    @Override
    public List<SubstituteMenuItem> createItems(SubstituteMenuContext context) {
