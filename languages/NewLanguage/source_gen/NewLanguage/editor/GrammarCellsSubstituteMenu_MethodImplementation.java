...
public class GrammarCellsSubstituteMenu_MethodImplementation extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_MethodImplementation() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_9kfz0n_a());
    return result;
  }
  ...
  private class GrammarCellsSubstituteMenuPart_9kfz0n_a extends GrammarCellsSubstituteMenuPart {
    @Override
