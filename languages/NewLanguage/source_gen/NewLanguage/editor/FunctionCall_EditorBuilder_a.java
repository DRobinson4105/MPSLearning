...
/*package*/ class FunctionCall_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new functionSingleRoleHandler_2b0q7v_a0(myNode, LINKS.function$ol5z, getEditorContext());
    return provider.createCell();
  }
  private static class functionSingleRoleHandler_2b0q7v_a0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public functionSingleRoleHandler_2b0q7v_a0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
    ...
    protected EditorCell createChildCell(SNode child) {
      ...
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), LINKS.function$ol5z, child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), LINKS.function$ol5z, child));
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      ...
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(LINKS.function$ol5z);
      }
    ...
    protected EditorCell createEmptyCell() {
      ...
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), LINKS.function$ol5z));
      try {
      ...
      public EditorCell invoke() {
        cell.setAction(CellActionType.DELETE, new CellActionWithReadAccess() {
          public void execute(EditorContext editorContext) {
            ...
            SNode unwrapped = SNodeOperations.replaceWithAnother(node, SLinkOperations.getTarget(node, LINKS.function$ol5z));
          ...
          public boolean canExecute_inReadAction(EditorContext editorContext) {
            ...
            SNode replacement = SLinkOperations.getTarget(node, LINKS.function$ol5z);
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_2b0q7v_a1a");
    Style style = new StyleImpl();
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new argumentsListHandler_2b0q7v_a2a(myNode, getEditorContext());
    EditorCell_Collection editorCell = handler.createCells(new CellLayout_Indent(), false);
    editorCell.setCellId("refNodeList_arguments");
    editorCell.setSRole(handler.getElementSRole());
    return editorCell;
  }
  private static class argumentsListHandler_2b0q7v_a2a extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public argumentsListHandler_2b0q7v_a2a(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(argumentsListHandler_2b0q7v_a2a.this.getNode(), LINKS.arguments$b$3));
      try {
    ...
    private EditorCell createConstant_1() {
      EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "");
      editorCell.setCellId("Constant_2b0q7v_a0a2a");
      editorCell.setDefaultText("");
      return editorCell;
    }
  }
  ...
  private EditorCell createConstant_2() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, ")");
    editorCell.setCellId("Constant_2b0q7v_a3a");
    Style style = new StyleImpl();
    style.set(StyleAttributes.PUNCTUATION_LEFT, true);
