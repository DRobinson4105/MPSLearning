...
public class GrammarCellsSubstituteMenu_BE_GreaterThan extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_BE_GreaterThan() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_51t8t_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "BE_GreaterThan", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_51t8t_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.BE_GreaterThan$O4;
    }
  }
