...
public class GrammarCellsSubstituteMenu_DoubleType extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_DoubleType() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_yw021v_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "DoubleType", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_yw021v_a extends GrammarCellsSubstituteMenuPart {
    @Override
