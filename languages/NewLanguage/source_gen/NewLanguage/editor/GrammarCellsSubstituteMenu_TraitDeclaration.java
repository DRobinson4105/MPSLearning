...
public class GrammarCellsSubstituteMenu_TraitDeclaration extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_TraitDeclaration() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_95dxhw_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "TraitDeclaration", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_95dxhw_a extends GrammarCellsSubstituteMenuPart {
    @Override
