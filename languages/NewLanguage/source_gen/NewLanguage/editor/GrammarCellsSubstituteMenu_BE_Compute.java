...
public class GrammarCellsSubstituteMenu_BE_Compute extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_BE_Compute() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_fjoaob_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "BE_Compute", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_fjoaob_a extends GrammarCellsSubstituteMenuPart {
    @Override
