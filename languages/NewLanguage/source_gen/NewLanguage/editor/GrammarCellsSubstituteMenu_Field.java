...
public class GrammarCellsSubstituteMenu_Field extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_Field() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_e6fhkf_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "Field", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_e6fhkf_a extends GrammarCellsSubstituteMenuPart {
    @Override
