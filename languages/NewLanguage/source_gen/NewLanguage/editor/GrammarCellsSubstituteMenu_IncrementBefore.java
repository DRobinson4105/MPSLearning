...
public class GrammarCellsSubstituteMenu_IncrementBefore extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_IncrementBefore() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_i4yyzd_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "IncrementBefore", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_i4yyzd_a extends GrammarCellsSubstituteMenuPart {
    @Override
