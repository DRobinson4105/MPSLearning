...
public class GrammarCellsSubstituteMenu_FunctionReference extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_FunctionReference() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_ujzh7_a());
    return result;
  }
  ...
  private class GrammarCellsSubstituteMenuPart_ujzh7_a extends GrammarCellsSubstituteMenuPart {
    @Override
