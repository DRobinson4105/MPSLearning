...
public class GrammarCellsSubstituteMenu_BreakStatement extends SubstituteMenuBase {
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "BreakStatement", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_at0va_a extends GrammarCellsSubstituteMenuPart {
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.BreakStatement$O0;
    }
  }
