...
public class GrammarCellsSubstituteMenu_MapType extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_MapType() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_1racjx_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "MapType", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_1racjx_a extends GrammarCellsSubstituteMenuPart {
    @Override
