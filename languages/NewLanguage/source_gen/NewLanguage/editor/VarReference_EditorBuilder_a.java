...
/*package*/ class VarReference_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.var$iTQl;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(() -> new Inline_Builder0(getEditorContext(), getNode(), targetNode).createCell(), targetNode, LINKS.var$iTQl);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.var$iTQl);
    }
    Style style = new StyleImpl();
    if (_StyleParameter_QueryFunction_ulohec_a0a0()) {
  ...
  private boolean _StyleParameter_QueryFunction_ulohec_a0a0() {
    return SNodeOperations.isInstanceOf(SLinkOperations.getTarget(getNode(), LINKS.var$iTQl), CONCEPTS.ThisVar$Zb);
  }
