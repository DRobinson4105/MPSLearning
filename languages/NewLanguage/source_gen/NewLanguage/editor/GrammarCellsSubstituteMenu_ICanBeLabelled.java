...
public class GrammarCellsSubstituteMenu_ICanBeLabelled extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_ICanBeLabelled() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_rwnuoe_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "ICanBeLabelled", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_rwnuoe_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.ICanBeLabelled$74;
    }
  }
