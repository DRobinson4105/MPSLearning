...
public class GrammarCellsSubstituteMenu_StructLiteral extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_StructLiteral() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_378yin_a());
    return result;
  }
  ...
  private class GrammarCellsSubstituteMenuPart_378yin_a extends GrammarCellsSubstituteMenuPart {
    @Override
