...
public class GrammarCellsSubstituteMenu_DoubleLiteral extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_DoubleLiteral() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_p0u0ht_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "DoubleLiteral", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_p0u0ht_a extends GrammarCellsSubstituteMenuPart {
    @Override
