...
public class GrammarCellsSubstituteMenu_NumType extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_NumType() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_dt40pu_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "NumType", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_dt40pu_a extends GrammarCellsSubstituteMenuPart {
    @Override
