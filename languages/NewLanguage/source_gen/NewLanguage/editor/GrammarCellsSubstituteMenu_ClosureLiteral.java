...
public class GrammarCellsSubstituteMenu_ClosureLiteral extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_ClosureLiteral() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_2idlag_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "ClosureLiteral", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_2idlag_a extends GrammarCellsSubstituteMenuPart {
    @Override
