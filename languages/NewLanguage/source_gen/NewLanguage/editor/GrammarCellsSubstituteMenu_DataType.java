...
public class GrammarCellsSubstituteMenu_DataType extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_DataType() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_wdly8g_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "DataType", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_wdly8g_a extends GrammarCellsSubstituteMenuPart {
    @Override
