...
/*package*/ class IncrementBefore_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public IncrementBefore_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_o2rrfj_a");
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_o2rrfj_a0a");
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new expSingleRoleHandler_o2rrfj_b0(myNode, LINKS.exp$gRXM, getEditorContext());
    return provider.createCell();
  }
  private static class expSingleRoleHandler_o2rrfj_b0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public expSingleRoleHandler_o2rrfj_b0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
