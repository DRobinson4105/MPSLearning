...
public class GrammarCellsSubstituteMenu_MapLiteral extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_MapLiteral() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_ux4gdj_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "MapLiteral", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_ux4gdj_a extends GrammarCellsSubstituteMenuPart {
    @Override
