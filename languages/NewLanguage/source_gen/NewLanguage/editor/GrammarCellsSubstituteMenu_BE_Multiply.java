...
public class GrammarCellsSubstituteMenu_BE_Multiply extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_BE_Multiply() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_ulotuq_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "BE_Multiply", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_ulotuq_a extends GrammarCellsSubstituteMenuPart {
    @Override
