...
public class GrammarCellsSubstituteMenu_Pair extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_Pair() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_8h9am3_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "Pair", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_8h9am3_a extends GrammarCellsSubstituteMenuPart {
    @Override
