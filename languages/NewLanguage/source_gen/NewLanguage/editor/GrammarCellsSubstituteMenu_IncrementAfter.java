...
public class GrammarCellsSubstituteMenu_IncrementAfter extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_IncrementAfter() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_7g9i3o_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "IncrementAfter", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_7g9i3o_a extends GrammarCellsSubstituteMenuPart {
    @Override
