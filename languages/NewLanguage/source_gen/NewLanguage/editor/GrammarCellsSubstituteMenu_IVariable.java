...
public class GrammarCellsSubstituteMenu_IVariable extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_IVariable() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_vfwh84_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "IVariable", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_vfwh84_a extends GrammarCellsSubstituteMenuPart {
    @Override
